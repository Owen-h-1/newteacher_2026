  ...
  <div class="smart-ppt-page">
    <div class="page-header">
      <div class="title-text">
        ...
        <p class="subtitle">选择教师上传的PPT，点击开始讲解后左侧数字人出现，右侧自动轮播PPT。</p>
      </div>
    </div>
...
.page-header .title-text h1 { margin: 0 0 8px; color: #0b2b4a; font-size: 26px; }
.page-header .subtitle { margin: 0; color: #5d7d9b; font-size: 15px; }
