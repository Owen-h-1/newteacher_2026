...
import {ContinuousChatButton} from "@/components/continuousChatButton";
        ...
        <div
            ...
            <div>
                ...
                <div style={{
                    ...
                    <ContinuousChatButton
                        onStateChange={(isActive) => {
                            console.log('Continuous chat:', isActive ? 'started' : 'stopped');
                        }}
                        onTranscribed={(text) => {
                            console.log('Transcribed:', text);
                            if (text && text.trim()) {
                                handleSendChat(globalConfig, 'user', globalConfig?.characterConfig?.yourName || 'User', text);
                            }
                        }}
                        onError={(error) => {
